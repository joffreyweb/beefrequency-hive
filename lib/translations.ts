...
5. Droit de fin. En cas de non-respect répété des règles, je me réserve le droit de suspendre l'accompagnement sans remboursement.`,
  ...
  morning: {
    ...
    step1Sub: { EN: "1 = drained · 10 = vibrant and aligned", FR: "1 = épuisé · 10 = vibrant et aligné" },
    step2Title: { EN: "Sleep", FR: "Sommeil" },
    step2Sub: { EN: "1 = restless sleep · 10 = restoring sleep", FR: "1 = sommeil agité · 10 = sommeil régénérant" },
    ...
    sleepLegerFlou: { EN: "Light / blurry", FR: "Léger / flou" },
    sleepProfondRep: { EN: "Deep / restoring", FR: "Profond / réparateur" },
    sleepReves: { EN: "Dreams present", FR: "Rêves présents" },
    sleepReveils: { EN: "Multiple awakenings", FR: "Réveils multiples" },
    sleepEndormissement: { EN: "Long to fall asleep", FR: "Long endormissement" },
    sleepContinue: { EN: "Continuous night", FR: "Nuit continue" },
    step3Title: { EN: "Sleep type", FR: "Type de sommeil" },
    dreamYes: { EN: "Yes", FR: "Oui" },
    dreamNo: { EN: "No", FR: "Non" },
    dreamBlurry: { EN: "I don't know", FR: "Je ne sais pas" },
    dreamPlaceholder: { EN: "Dreams / messages received in the night…", FR: "Rêves / messages reçus dans la nuit…" },
    step5Title: {
      EN: "Gratitude for this day",
      FR: "La gratitude pour cette journée",
    },
    step5Placeholder: {
