...
// Garde-fou d'erreur pour TOUT l'espace client : au lieu d'une page blanche muette,
// on affiche un message clair + une réf. technique (digest) pour le debug.
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-16 text-center">
      ...
      <p className="font-ui text-sm text-brun-mid mb-6">
        {T({
          EN: "Nothing is lost. Try again — if the issue persists, let Joffrey know.",
          FR: "Rien n'est perdu. Réessaie — si le souci persiste, préviens Joffrey.",
        })}
      </p>
